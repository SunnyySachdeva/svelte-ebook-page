...
<!-- number title strapline excerpt -->
<section class="chapter-preview">
    <div class="chapter-titles">
        ...
        <ul>
            ...
            <li>
                <button onclick={() => currentChapter=chapter.number } class:button-pressed={currentChapter === chapter.number}>
    ...
    <div class="chapter-excerpt">
        <!-- {chapters.find((chapter) => chapter.number === currentChapter).strapline} -->
        {#each chapters as chapter}
            {#if chapter.number === currentChapter}
                <h4 class="italic">{chapter.strapline}</h4>
                <p>{chapter.excerpt}</p>
            {/if}
        {/each}
    </div>
